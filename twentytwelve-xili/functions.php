...
function twentytwelve_xilidev_setup () {
	...
	// Args dedicaced to this theme named Twenty Twelve
		$xili_args = array (
		...
		if ( $class_ok ) {
			...
			<div class="error">'.
				/* translators: added in child functions by xili */
				'<p>' . sprintf ( __('The %s child theme requires xili_language_theme_options class installed and activated', 'twentytwelve' ), get_option( 'current_theme' ) ).'</p>
			</div>';
